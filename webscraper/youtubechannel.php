...
//niga higa ,superwoman ,jus reign ,college humour
require_once('main/init.php');
$q = $_POST['query'];
if($q){
$url="https://www.googleapis.com/youtube/v3/search?channelId=UCJ98xGeWxpuKDAb2-Xs01Ug&part=snippet&type=video&key=AIzaSyCWHM2Eqr15ScWTGgIB7BxUymK9nI94TvY&order=date&maxResults=50";  
...
$vid_url = "https://www.youtube.com/watch?v=".$vid_id;
 ...
 $video =preg_replace("/\s*[a-zA-Z\/\/:\.]*youtube.com\/watch\?v=([a-zA-Z0-9\-_]+)([a-zA-Z0-9\/\*\-\_\?\&\;\%\=\.]*)/i","<iframe width=\"420\" height=\"315\" src=\"//www.youtube.com/embed/$1\" frameborder=\"0\" allowfullscreen></iframe>",$vid_url);
    ...
    $vid_title = str_replace("'","\'",$vid_title);
        $vid_title = str_replace('"','\"',$vid_title);
    ...
    if(!$result){
    	...
    	die("INSERTION ERROR niga higa".mysqli_error($conn));
    }
