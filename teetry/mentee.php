<?php
	...
	function upload_image(){
		...
		else
		{
			...
			$newname="images/men/".$image_name;
	 		$img_url = "http://youni.co.in/teetry/images/men/".$image_name;
...
function upload_image1(){
	...
	if (isset($name) &&isset($price)) 
	{
					...
					$query1 = "SELECT * FROM `mentees` WHERE mteename ='$name' AND mteeprice = '$price'";
					...
					if(mysqli_num_rows($result) > 0){
						...
						$query = "INSERT INTO `mentees`(`mteename`,`mteeprice`,`mteelink`,`mteedisplayimageurl`,`mteeimageurl`,`mteefeature1`,`mteefeature2`,`mteefeature3`,`mteefeature4`) VALUES('".$name."','".$price."','".$link."','".$image_url."','".$image_url1."','".$feature1."','".$feature2."','".$feature3."','".$feature4."')";
						if($conn->query($query)){
							echo "Successfull";		
						}else{
