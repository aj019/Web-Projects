...
<html lang="en">
  ...
  <body>
      ...
      <div id="first-content" class="container">
        <div class="row">
          <div id="logo" class="col-md-10 col-md-offset-1 text-left">
            <a href="index.php"><h1>JEE<span style="color:rgb(130,153,170);">Teacher</span></h1></a>
      ...
      <div id="what-do-we-offer-content" class="container text-center">
        <div class="row">
          <div class="col-md-6 col-md-offset-3">
            ...
            <p class="text">
              We offer truly mind blowing learning experiences in all JEE related subjects and topics.
              We'll make you understand anything you're struggling with, through our live tutoring classes.
            </p><br>
            <p class="text">
        ...
        <div class="row">
          ...
          <div class="col-md-4 col-md-offset-4 text-left">
            ...
            <p style="padding-top:15px;" class="text text-left">
              ...
              for a live tutoring lesson.The session will look similar to Khan Academy videos.
            </p>
          </div>
        </div>
    </section>
        ...
        <div class="row">
          <div class="col-md-8 col-md-offset-2">
            ...
            <div id="content-box">
              ...
              <p style="padding:0px; color:#FFFFFF;" class="text-second">
                We basically want to create content for youtube and we may use the tutorial as a youtube video.
              </p>
    ...
    <footer class="text-center">
      <p>
        &copy JEETeacher, 2016
        <a href="https://www.facebook.com/JeeTeacher-115575408867163/" target="_blank"><img src="data/facebook.png" alt="facebook" width="30" height="30" /></a>
      </p>
    </footer>
    <!--footer end-->
