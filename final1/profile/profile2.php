		...
		<!-- Tabs -->
		    <div class="tabs-profile">
			    <ul class="tab-links-profile">
			        ...
			        <li class="active-profile"><a href="#tab2-profile">Uploads</a></li>
				...
				<div class="tab-content-profile">
					...
					<!-- Tab 2 -->
					<div id="tab2-profile" class="tab-profile active-profile">
           				<?php    
           				    $articlesquery1=$db->query("

							    SELECT *
							    FROM articles 
							    WHERE user_id = '$id' ORDER BY date_creation DESC
