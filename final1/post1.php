    ...
    <div class="clear-fix"></div> 
       <div class="left-col">
        <div id="trending">
          ...
          ?>
            <li><a href="search/index_searchresults1.php?search_bar=%23<?php $tag_w_hash = str_replace('#', '' , $trending->tag); echo $tag_w_hash; ?>"><?php echo $trending->tag ; ?></a></li>
          <?php endforeach;?>
          </ul>
          ...
          <div class="clear-fix"></div>
            ...
            <a href="post1.php?id=<?php echo $articles->article_id ?>" target ="_blank"><img type="submit" src='<?php echo "upload/" .$articles->url?>' id="meme"></a>
             ...
             <div class="tags">
              <table>
                <tr>
                 <td><a href="search/index_searchresults1.php?search_bar=%23<?php echo "$tag_w_hash1";?>"><?php echo $articles->tag1 ?></a></td>
                 <td><a href="search/index_searchresults1.php?search_bar=%23<?php echo "$tag_w_hash2";?>"><?php echo $articles->tag2 ?></a></td>
                 <td><a href="search/index_searchresults1.php?search_bar=%23<?php echo "$tag_w_hash3";?>"><?php echo $articles->tag3 ?></a></td>
                </tr>
              </table>
             </div>
        ...
        <?php } else{ ?>
          ...
          <div class="clear-fix"></div>
            ...
            <?php
              ...
              echo '<div class="youtube-article"><iframe class="dt-youtube" width="100%" height="458" src="//www.youtube.com/embed/'.$id
