...
<html>
<head>
	<title>Memeveme | Popular</title>
	<meta name="description" content="Discover the most poopular funny pics, GIFs, Indian memes and youtube videos on the internet. Memeveme is the best place to share something fun online.">
	<meta name="keywords" content="funny, gif, youtube videos, nsfw, funny pics, images, trending tags, popular, lol, happy, jokes, memes, trolls, awesome, fun, hilarious">
	<meta property = "og:title" content="Memeveme|Popular"/>
	<meta property = "og:type" content="website"/>
	<meta property = "og:url" content="http://memeveme.com/pages/popular.php"/>
	<meta property = "og:image" content="http://memeveme.com/resources/memeveme_logo.png"/>
	...
	<meta name="twitter:url" content="http://memeveme.com/pages/popular.php"/>
	<meta name="twitter:title" content="Memeveme|Popular"/>
	<meta name="twitter:description" content="Memeveme is home of the funniest content from India and the world."/>
	<meta name="twitter:image" content="http://memeveme.com/resources/memeveme_logo.png"/>
			...
			$(window).scroll(function(){
				if ($(window).scrollTop() == $(document).height() - $(window).height()){
					if($(".pagenum:last").val() <= $(".total-page").val()) {
						...
						getresult('getresult_popular1.php?page='+pagenum);
					}
				}
			}); 
		});
	...
	?>
		<div id="wrapper">
			...
			<div class ="right-col">
				<div id="container">
					<div id="faq-result">
					<?php include('getresult_popular1.php'); ?>
				</div>
