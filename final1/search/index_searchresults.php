	...
	<div class="menu-container">
			...
			<div class="right-menu">
					<div class="search-bar-container">
						<form method="GET" action="index_searchresults.php" style="margin:0;"> 
			     ...
			     <div class="left-col">
					  <div id="trending">
						  ...
						  <h4 >Trending Tags</h4>
							...
							?>
								<li><a href="index_searchresults.php?search_bar=%23<?php $tag_w_hash = str_replace('#', '' , $trending->tag); echo $tag_w_hash; ?>">
		 ...
		 <div class="search">
	        ...
	        foreach ($articles as $articles): 
				...
				<div id="segment">
					...
					<div class="clear-fix"></div>
						<h1><a href="../post.php?id=<?php echo $articles->article_id ?>" target ="_blank"><?php echo $articles->title ?></a></h1>
						...
						<a href="../post.php?id=<?php echo $articles->article_id ?>" target ="_blank"><img type="submit" src='<?php echo "../upload/" .$articles->url?>' id="meme"></a>
						 ...
						 <div class="tags">
						  <table>
						    <tr>
						  	 <td><a href="index_searchresults.php?search_bar=%23<?php $tag_w_hash = str_replace('#', '' , $articles->tag1); echo $tag_w_hash; ?>">
						  	 	<?php echo $articles->tag1 ?></a></td>
						  	 <td><a href="index_searchresults.php?search_bar=%23<?php $tag_w_hash = str_replace('#', '' , $articles->tag2); echo $tag_w_hash; ?>">
						  	 	<?php echo $articles->tag2 ?></a></td>
						  	 <td><a href="index_searchresults.php?search_bar=%23<?php $tag_w_hash = str_replace('#', '' , $articles->tag3); echo $tag_w_hash; ?>">
