					...
					<div class="clear-fix"></div>
						...
						<a href="post.php?id=<?php echo $articles->article_id ?>" target ="_blank"><img type="submit" src='<?php echo "upload/" .$articles->url?>' id="meme"></a>
						 ...
						 <div class="tags">
						  <table>
						    <tr>
						  	 <td><a href="search/index_searchresults.php?search_bar=%23<?php echo "$tag_w_hash1";?>"><?php echo $articles->tag1 ?></a></td>
						  	 <td><a href="search/index_searchresults.php?search_bar=%23<?php echo "$tag_w_hash2";?>"><?php echo $articles->tag2 ?></a></td>
						  	 <td><a href="search/index_searchresults.php?search_bar=%23<?php echo "$tag_w_hash3";?>"><?php echo $articles->tag3 ?></a></td>
						    </tr>
						  </table>
						 </div>
