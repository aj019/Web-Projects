			...
			<div class="menu-container">
				...
				<div class="right-menu">
					<div class="search-bar-container">
						<form method="POST" action="search/index_searchresults1.php" style="margin:0;"> 
					...
					<div class="right-menu-buttons">
						<ul id="click-nav">
		                	<li><a href="#"><img class="user-notification-icon" onClick="notifications_remove()" src = "resources/memeveme_notification_bell.png"></a>
		                    	<div class="subs">
		                        	<div>
		                            	<ul>
	            		...
	            		<a href="upload/upload.php" target="_blank"><button class="upload-right-menu-button" href="upload/upload.php">Upload</button></a>
					</div>
				</div>
			</div>
