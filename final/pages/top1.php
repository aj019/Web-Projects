...
<head>
	...
	<meta property = "og:url" content="http://memeveme.com/index.php"/>
	...
	<meta name="twitter:url" content="http://memeveme.com/index.php"/>
			...
			$(window).scroll(function(){
				if ($(window).scrollTop() == $(document).height() - $(window).height()){
					if($(".pagenum:last").val() <= $(".total-page").val()) {
						...
						getresult('getresult_top1.php?page='+pagenum);
					}
				}
			}); 
		});
	...
	?>
		<div id="wrapper">
			...
			<div class ="right-col">
				<div id="container">
					<div id="faq-result">
					<?php include('getresult_top1.php'); ?>
				</div>
			...
			<div class="sidebar">
					<div class="about">
						...
						<ul>
							<li><a><img src="../resources/Facebook.png"></a></li>
							<li><a><img src="../resources/Twitter.png"></a></li>
							<li><a><img src="../resources/Google+.png"></a></li>
							<li><a><img src="../resources/Instgram.png"></a></li>
							<li><a><img src="../resources/Youtube.png"></a></li>
						</ul>	
					</div>
					<hr>
