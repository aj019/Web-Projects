...
<html>
<head>
	<title>Memeveme | Funny Videos </title>
	<meta name="description" content="The funniest youtube videos featuring the best pranks, Indian standup comics, funny plot sketches from all around the world.">
	<meta name="keywords" content="funny, gif, youtube videos, standup, comics, funniest, nsfw, funny pics, popular, lol, happy, jokes, memes, trolls, fun">
	<meta property = "og:title" content="Memeveme|Funny Videos"/>
	<meta property = "og:type" content="website"/>
	<meta property = "og:url" content="http://memeveme.com/pages/videos.php"/>
	<meta property = "og:image" content="http://memeveme.com/resources/videos.png"/>
	...
	<meta name="twitter:url" content="http://memeveme.com/pages/videos.php"/>
	<meta name="twitter:title" content="Memeveme|Funny Videos"/>
	<meta name="twitter:description" content="Memeveme is home of the funniest content from India and the world."/>
	<meta name="twitter:image" content="http://memeveme.com/resources/videos.png"/>
			...
			$(window).scroll(function(){
				if ($(window).scrollTop() == $(document).height() - $(window).height()){
					if($(".pagenum:last").val() <= $(".total-page").val()) {
						...
						getresult('getresult_videos1.php?page='+pagenum);
					}
		../resources/		}
			}); 
		});
	...
	?>
		<div id="wrapper">
			...
			<div class ="right-col">
				<div id="container">
					<div id="faq-result">
					<?php include('getresult_videos1.php'); ?>
				</div>
