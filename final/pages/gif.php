...
<html>
<head>
	<title>Memeveme | Funny GIFs</title>
	<meta name="description" content="Ridiculously funny animated GIFs guaranteed to tickle your funny bone.">
	<meta name="keywords" content="funny, gif, funny pics, images, lol, rofl, indian, bollywood memes, trolls">
	<meta property = "og:title" content="Memeveme|Funny GIFs"/>
	<meta property = "og:type" content="website"/>
	<meta property = "og:url" content="http://memeveme.com/gif.php"/>
	<meta property = "og:image" content="Memeveme"/>
	...
	<meta name="twitter:url" content="http://memeveme.com/pages/gif.php"/>
	<meta name="twitter:title" content="Memeveme|Funny GIFs"/>
	<meta name="twitter:description" content="Memeveme is home of the funniest content from India."/>
	<meta name="twitter:image" content="http://memeveme.com/resources/gifs.png"/>
			...
			$(window).scroll(function(){
				if ($(window).scrollTop() == $(document).height() - $(window).height()){
					if($(".pagenum:last").val() <= $(".total-page").val()) {
						...
						getresult('getresult_gif.php?page='+pagenum);
					}
				}
			}); 
		});
