...
<html>
<head>
	<title>Memeveme | Funny Memes</title>
	<meta name="description" content="Laugh at the best memes and trolls about bollywood, cricket, TV soaps, CID, Rajnikant, Alia Bhatt, Alok Nath and more.">
	<meta name="keywords" content="funny, gif, bollwood memes, alia bhatt memes, alok nath memes, Rajnikant, CID memes, funny pics, images, lol, happy, jokes, memes, trolls, awesome, fun, cute, memeveme, hilarious">
	<meta property = "og:title" content="Memeveme|Funny Memes"/>
	<meta property = "og:type" content="website"/>
	<meta property = "og:url" content="http://memeveme.com/pages/memes.php"/>
	<meta property = "og:image" content="http://memeveme.com/resources/memes.png"/>
	...
	<meta name="twitter:url" content="http://memeveme.com/pages/memes.php"/>
	<meta name="twitter:title" content="Memeveme|Funny Memes"/>
	<meta name="twitter:description" content="Memeveme is home of the funniest content from India and the world."/>
	<meta name="twitter:image" content="http://memeveme.com/resources/memes.png"/>
			...
			$(window).scroll(function(){
				if ($(window).scrollTop() == $(document).height() - $(window).height()){
					if($(".pagenum:last").val() <= $(".total-page").val()) {
						...
						getresult('getresult_memes.php?page='+pagenum);
					}
				}
			}); 
		});
...
<body>
	...
	?>
		...
		<div class ="right-col">
			<div id="container">
				<div id="faq-result">
				<?php include('getresult_memes.php'); ?>
				</div>
