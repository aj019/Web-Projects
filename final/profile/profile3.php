		...
		<!-- Tabs -->
		    <div class="tabs-profile">
			    <ul class="tab-links-profile">
			        <li><a href="profile1.php?id=<?php echo $id ?>">All Activity</a></li>
			        <li><a href="profile2.php?id=<?php echo $id ?>">Uploads</a></li>
			        <li class="active-profile"><a href="#tab3-profile">Upvoted</a></li>
			       
			    </ul>
				<div class="tab-content-profile">
			        <!-- Tab 1 -->
			        <div id="tab1-profile" class="tab-profile">	 

						
					</div>

					<!-- Tab 2 -->
					<div id="tab3-profile" class="tab-profile active-profile">
           				<?php    
           				    $articlesquery1=$db->query("
							  ...
							  while ($row5= $articlesquery1->fetch_object()) {
							  	
							  	$articles1[]= $row5;

							  }
					        foreach ($articles1 as $articles1): 
					        	if($articles1->mv==1) {?>
								...
								<div id="segment">
									...
									$articlesquery1="
									    ...
									    SELECT login.*
									     ...
									     WHERE articles.article_id=$articles1->article_id
									...
									<div class="clear-fix"></div>
										...
										<a href="../post1.php?id=<?php echo $articles1->article_id ?>" target ="_blank"><img type="submit" src='<?php echo "../upload/" .$articles1->url?>' id="meme"></a>
										 <div class="clear-fix"></div>
										 <div class="tags">
										  <table>
										    <tr>
										  	 <td><a href="#"><?php echo $articles1->tag1 ?></a></td>
										  	 <td><a href="#"><?php echo $articles1->tag2 ?></a></td>
										  	 <td><a href="#"><?php echo $articles1->tag3 ?></a></td>
										    </tr>
										  </table>
										 </div>
										 ...
										 <?php
									          $articlesquery1="
									              ...
									              SELECT *
									               FROM votes
									               WHERE article_id='$articles1->article_id' AND user_id= '".$_SESSION['userprofile']['id']."'
									       ...
									       <?php if($articles1->user_id==$_SESSION['userprofile']['id']){ ?>
										 <p  class="upvotes" id="upvotes<?php echo $articles1->article_id ?>"><?php echo $articles1->total_upvotes?></p>
										 <img class="up"   id="up<?php echo $articles1->article_id ?>" src="../resources/up3.png">
										<img  class="down"   id="down<?php echo $articles1->article_id ?>" src="../resources/down.png">
											<?php } else {?>
										<p  class="upvotes" id="upvotes<?php echo $articles1->article_id ?>"><?php echo $articles1->total_upvotes?></p>
										 <img class="up" onclick="upvotes(<?php echo $articles1->article_id ?>)"  id="up<?php echo $articles1->article_id ?>" src="../resources/up<?php echo $row1['status']; ?>.png">
										<img  class="down" onclick="downvotes(<?php echo $articles1->article_id ?>)"  id="down<?php echo $articles1->article_id ?>" src="../resources/down<?php echo $row1['status']; ?>.png">	
										<?php }?>
										<div id="report<?php echo $articles1->article_id ?>" class="report_popup">
											<form method="post" action="report/report.php">
												<ul>
													...
													<input type="hidden" name="article_id" value="<?php echo $articles1->article_id ?>">
													<li><input type="submit" name="submit" value="Report"></li>
												</ul>
											</form>	
										</div>
										<div id="report-fade<?php echo $articles1->article_id ?>" class="report-fade" onClick="report_close(<?php echo $articles1->article_id ?>);"></div>
										<img style="float:right;" class="report" onClick='report_open(<?php echo $articles1->article_id ?>);' src="../resources/report.png">
								...
								<?php } else{ ?>
									...
									<div class="clear-fix"></div>
										...
										<?php
										 ...
										 <p  class="upvotes" id="upvotes<?php echo $articles1->article_id ?>"><?php echo $articles1->total_upvotes?></p>
										 <img class="up"   id="up<?php echo $articles1->article_id ?>" src="../resources/up3.png">
										<img  class="down"   id="down<?php echo $articles1->article_id ?>" src="../resources/down1.png">
											<?php } else {?>
										<p  class="upvotes" id="upvotes<?php echo $articles1->article_id ?>"><?php echo $articles1->total_upvotes?></p>
										 <img class="up" onclick="upvotes(<?php echo $articles1->article_id ?>)"  id="up<?php echo $articles1->article_id ?>" src="../resources/up<?php echo $row1['status']; ?>.png">
										<img  class="down" onclick="downvotes(<?php echo $articles1->article_id ?>)"  id="down<?php echo $articles1->article_id ?>" src="../resources/down<?php echo $row1['status']; ?>.png">	
						...
						<a href="https://plus.google.com/share?url=http%3A%2F%2Fmemeveme.com%2Fpost.php%3Fid%3D$articles->article_id" target="_blank"><img style="float:right;" class="google-share" src="../resources/g1.png"></a>
						<a href="https://twitter.com/intent/tweet?url=http%3A%2F%2Fmemeveme.com%2Fpost.php%3Fid%3D$articles->article_id&text=$articles->title&via=Memeveme" target="_blank"><img style="float:right;" class="twitter-share" src="../resources/t1.png"></a>
						<a href="https://www.facebook.com/sharer/sharer.php?u=http%3A%2F%2Fmemeveme.com%2Fpost.php%3Fid%3D$articles->article_id" target="_blank"><img style="float:right;" class="facebook-share" src="../resources/f1.png"></a></div>
										<hr>
