...
<div class="maincontainer">
	...
	<div class="welcome">
		...
		<h2>Hi, <?php echo $_SESSION['authstation']; ?></h2>
		<h2><?php echo $_SERVER['REQUEST_URI'];?></h2>
		<p><?php echo $_SESSION['app'] ;?></p>
	...
	<div class="details">
		...
		<img src="<?php echo 'https://graph.facebook.com/'.$_SESSION["userprofile"]['id'].'/picture' ?>">
		<img src="<?php echo $_SESSION["userprofile"]['picture'] ?>">
		<img src="<?php echo $_SESSION["userprofile"]['profile_image_url'] ?>">		
	</div>
	<!-- End Details -->
