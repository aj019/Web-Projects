...
$username = $water_mark_text_1 ="Kushan Singh";
$email = "k@gma.com";
$coursename = $water_mark_text_2 = "This String is to test whether the watermark is working correctly or not so that i can correct it if ";
...
/*    $newstr = $water_mark_text_2;
    for($i=0;$i<strlen($water_mark_text_2);$i++){
    	$pos = $water_mark_text_2{$i};
    	if($pos == ' '){
    		$spaces++;
    		if($spaces == 5 || $spaces == 10){
    		$newstr = substr_replace($newstr,"~", $i,1);
    	   }
    	}
