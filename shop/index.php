    ...
    <body>		
			...
			<div class="row">
				...
				<div class="span8">
					<div class="account pull-right">
						<ul class="user-menu">				
							<li><a href="keranjang.php">Anuj Gupta</a></li>							
						</ul>
					</div>
				</div>
			</div>
		...
		<div id="wrapper" class="container">
				...
				<div class="row">
					<div class="span12">													
						<div class="row">
							<div class="span12">
								<h4 class="title">
									<span class="pull-left"><span class="text"><span class="line">Kaos <strong>Terbaru</strong></span></span></span>
			...
			<section class="our_client">
				<h4 class="title"><span class="text">Merk Kaos</span></h4>
				<div class="row">					
					<div class="span2">
