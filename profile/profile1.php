...
border: 1px solid rgb(177, 181, 180);
...
font-weight: 300;
color: white;
background-color: rgb(59, 195, 138);
padding: 8px;
...
<div class="outer-wrapper">
		...
		<div class="left-col">
	       <div class="user">
	       	  <img id="profile-pic" src="resources/pic2.jpg">
	      
	       	  <h2>Karishma Marvaha</h2>
	       	  </div>
