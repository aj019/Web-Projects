...
<head>
  ...
  <meta name="title" content="<?php echo $articles->title ?>">
  <meta name="keywords" content="Indian memes,indian videos,gif">
  <meta name="description" content="The Best Killers in Hollywood. - 9GAG has the best funny pics, GIFs, videos, memes, cute, wtf, geeky, cosplay photos on the web. We are your best source of happiness and awesomeness.">  
  <meta property="og:title" content="<?php echo $articles->title ?>">
  <meta property="og:site_name" content="Memeveme">
  <meta property="og:url" content="http://localhost/crastle/post.php?id=1">
  <meta property="og:description" content="Click to see the pic and write a comment...">
  <meta property="og:type" content="article">
  <meta property="og:image" content="<?php echo $articles->images ?>">
  <meta property="fb:app_id" content="1404456026519104">
    ...
    <div id="container">
      ...
      <?php    
          foreach ($articles as $articles): ?>
            ...
            <input type="hidden" name='name' value="<?php echo $articles->id ?>"> 
        <div id="segment">
            <h1><?php echo $articles->title ?></h1>
            <img type="submit" src="<?php echo $articles->images ?>" id="meme">
             <div class="clear-fix"></div>
             <div class="tags">
              <table>
                <tr>
            ...
            <a href="https://www.facebook.com/sharer/sharer.php?app_id=309437425817038&sdk=joey&u=http%3A%2F%2Flocalhost%2Fcrastle%2Fpost.php%3Fid%3D1&display=popup&ref=plugin" target="_blank"><img style="float:right;" class="google-share" src="resources/g1.png"></a>
